            ...
            while (c1 != (char) -1) {
                ...
                if (!flag) // flag==true means it is in property content
                {
                    if (c == '(') {
                        ...
                        // System.out.println("Ok end of the file");
                        brotherStack.pop();
                        break;
                    } else if (c == ')') {
                        level--;
                    ...
                    if ("SE".equals(property) || "SZ".equals(property)) // size
                    // //$NON-NLS-1$
                    // //$NON-NLS-2$
                    // of
                    // the
                    ...
                    } else if (property.equals("VW")) // View only part of the
                    // //$NON-NLS-1$
                    // board.
                    {
                        if (content.length() == 5) {
                    ...
                    // //$NON-NLS-1$
                    {
                        ...
                        if (content.length() == 2) {
                            latestNode.setPoint(SgfPoint.createFromSgf(content));
