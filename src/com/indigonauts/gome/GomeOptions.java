...
public class GomeOptions {
    ...
    public static final Font FONT_SMALL = Font.getFont(Font.FACE_PROPORTIONAL, Font.STYLE_PLAIN, Font.SIZE_SMALL);
    public static final Font FONT_MEDIUM = Font.getFont(Font.FACE_PROPORTIONAL, Font.STYLE_PLAIN, Font.SIZE_MEDIUM);
    public static final Font FONT_LARGE = Font.getFont(Font.FACE_PROPORTIONAL, Font.STYLE_PLAIN, Font.SIZE_LARGE);
    ...
    public Font scrollerFont = FONT_MEDIUM;
    ...
    public void setScrollerFontFromByte(byte fontByte) {
        ...
        switch (fontByte) {
        case SMALL:
            scrollerFont = FONT_SMALL;
            break;
        case MEDIUM:
            scrollerFont = FONT_MEDIUM;
            break;
        case LARGE:
            scrollerFont = FONT_LARGE;
            break;
        }
    }
    ...
    public byte getScrollerFontByte() {
        if (scrollerFont == FONT_SMALL)
            return SMALL;
        else if (scrollerFont == FONT_MEDIUM)
            return MEDIUM;
        else if (scrollerFont == FONT_LARGE)
            return LARGE;
        return -1;
    }
    ...
    public int getScrollerSize() {
        int fontSize = scrollerFont.getHeight();
        switch (scrollerSize) {
        default:
        case SMALL:
            return fontSize;
