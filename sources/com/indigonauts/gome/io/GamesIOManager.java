...
public class GamesIOManager extends IOManager {
  ...
  //#ifdef DEBUG
  private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger("GamesIOManager");
   ...
   * @throws IOException
   */
  public static SgfModel extractGameFromCollection(String url, int gameIndex, DownloadStatus status) throws IllegalArgumentException, IOException {
    //#ifdef DEBUG
    log.debug("Load " + url);
    //#endif
    SgfModel game = null;
