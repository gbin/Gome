...
public class Util {
    ...
    public static Image renderOffScreenScrollableText(String text, int width, int scrollHeight, Font font, int fgColor,
                                                      int bgcolor) {
    ...
    private static void drawText(Graphics graphics, int x, int y, int width, int heigth, Vector lines, Font font,
    ...
    public static void renderSplash(Graphics g, String splashInfo, int totalwidth, int totalHeight, Font info_font,
                                    int fg, int bg) {
    ...
    private static final char[] KEY = { 't', 'h', 'e', ' ', '$', ' ', 'a', 's', 'k', 'e', 'd', ' ', 'f', 'o', 'r', ' ',
                                       'G', 'o', 'm', 'e', ' ', 'i', 's', ' ', '1', '0', '0', '%', ' ', 'i', 'n', 'v',
                                       'e', 's', 't', 'e', 'd', ' ', 'i', 'n', ' ', 'i', 'm', 'p', 'r', 'o', 'v', 'i',
                                       'n', 'g', ' ', 'i', 't', ' ', 'd', 'o', ' ', 't', 'h', 'e', ' ', 'u', 's', 'e',
                                       'r', 's', ' ', 'a', ' ', 'r', 'e', 'a', 'l', ' ', 'f', 'a', 'v', 'o', 'r', ' ',
                                       'd', 'o', 'n', '\'', 't', ' ', 'c', 'r', 'a', 'c', 'k', ' ', 'm', 'e' };
