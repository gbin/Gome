...
public class FileBrowserV1 implements CommandListener, Showable, DownloadCallback {
  ...
  private FileBrowserV1(Showable parent, MenuEngine listener, boolean saveMode) {
  ...
  public FileBrowserV1(Showable parent, MenuEngine listener, Vector entries, String path, boolean saveMode) {
  ...
  public void downloadFinished(String path, Vector files) {
    FileBrowserV1 son = new FileBrowserV1(this, listener, files, path, saveMode);
