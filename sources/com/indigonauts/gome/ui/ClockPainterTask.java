...
public class ClockPainterTask extends TimerTask {
  ...
  public void drawClock(Graphics g, ClockController clock) {
    ...
    if (clock.thereIsClock()) {
      ...
      if (clock.isBlackOnByo() && byoStoneBlack != 0 && (clock.remainingTimeBlack() / byoStoneBlack < 5) && clock.getColor() == Board.BLACK)
      ...
      xPos += dis + 1;
      int stoneYpos = y + height - sizeOfCircle - textFont.getBaselinePosition();
